...
{
	/* var vote_win	=	window.open('http://photo.auto.sina.com.cn/exhi_new/vote_model.php?gid=32&type='+type+'&modelid='+modelid);
	vote_win.focus(); */
	console.log("aaa");
	$.ajax({
		async:true,
		...
		var str="";
			...
			"<ul><li><input type='button' onclick='vote("+key+")'><em>"+data[key].poll+"</em>票</li></ul>"+
